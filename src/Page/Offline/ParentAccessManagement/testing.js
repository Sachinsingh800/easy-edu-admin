            ...
            <Card>
              <CardContent>
                <Box sx={{ display: "flex", gap: 2, mb: 2 }}>
                  <Avatar src={enrollment.profilePic?.url}>
                ...
                <Box sx={{ mt: 2 }}>
                  ...
                  <Typography>Student Name: Drishya Sharma</Typography>
                  <Typography>Father's Name: ABCD</Typography>
                  <Typography>Mother's Name: XYZ</Typography>
                  <Typography>Date of Birth: 2005-06-27</Typography>
                  <Typography>Gender: Female</Typography>
                  <Typography>Address: GFUGUWREFOL3RJG3RG3RWG</Typography>
                  <Typography>Contact Number: 8789535136</Typography>
                  <Typography>Father's Contact: 8789535137</Typography>

                  {/* School Information */}
                  <Typography variant="h6" sx={{ mt: 2 }} gutterBottom>
                    Academic Information
                  </Typography>
                  <Typography>School: HOHOI</Typography>
                  <Typography>Course: MATHS</Typography>

                  {/* Enrollment Details */}
                  <Typography variant="h6" sx={{ mt: 2 }} gutterBottom>
                    Enrollment Details
                  </Typography>
                  <Typography>Class: {enrollment?.clsId?.className}</Typography>
                  <Typography>
                    Subject: {enrollment?.subjectId?.subjectName}
                  </Typography>
                  <Typography>
                    Batch: {enrollment?.batchYearId?.batchYear}
                  </Typography>
                </Box>
              </CardContent>
            </Card>
                      ...
                      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                        {selected.map((studentId) => {
                          ...
                          return (
                            <Chip
                              key={studentId}
                              label={`${student?.studentName} (${studentId})`}
                            />
                          );
                        })}
                      </Box>
