...
const CreateBatchDescription = ({ open, handleClose, id }) => {
  ...
  useEffect(() => {
    ...
    const fetchSubjects = async () => {
      try {
        const response = await axios.get(
          "https://lmsapp-plvj.onrender.com/admin/subjects/getAll",
          {
            headers: {
              "x-admin-token": token,
            },
    ...
    const fetchTeachers = async () => {
      try {
        const response = await axios.get(
          "https://lmsapp-plvj.onrender.com/admin/teachers/getAll",
          {
            headers: {
              "x-admin-token": token,
            },
  ...
  const handleSubmit = async () => {
    const token = Cookies.get("token");
    const url = `https://lmsapp-plvj.onrender.com/admin/batches/discription/create/${id}`;
